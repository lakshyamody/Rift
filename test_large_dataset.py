...
def test_backend_with_large_csv():
    # Path to sample CSV
    csv_path = "data/test_case_large.csv"
    ...
    with open(csv_path, "rb") as f:
        response = client.post("/detect", files={"file": ("test_case_large.csv", f, "text/csv")})
    ...
    if response.status_code == 200:
        ...
        if suspicious:
            ...
            for acc in suspicious[:5]: # Show top 5 suspicious
