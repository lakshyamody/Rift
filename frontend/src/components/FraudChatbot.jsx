...
const QUESTIONS = {
    ...
    default: ["Summarize this fraud ring.", "Which accounts should be frozen first?", "What laundering techniques were used?", "Are there connections to other rings?", "What should investigators do next?", "Which account has the highest suspicion score?", "How long did this operation run?", "What is the total money detected in Muling?"],
};
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar px-5 py-4 space-y-5">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <StatCard label="Money detected in Muling" icon={DollarSign} color="text-red-400"
